...
\begin{frame}
  ...
  \begin{itemize}
  \item Predict liklihood of a ontology term $T_i$ given a set of
    features $\{B\}$
  ...
  \item For a new compound in library, obtain probability of term $T_i$ using
    model $M_i$
  \item Aggregate top $n$ terms from each model for each compound in
...
\vskip 1em
  ...
  \item The terms exhibit hierarchical relationships and ignoring them
    is simplistic
  \end{itemize}
\end{frame}
